...
import { FaShippingFast,FaShareAlt, FaHeadset, FaShoppingCart, FaGift, FaStar, FaStarHalfAlt ,FaArrowLeft} from 'react-icons/fa';
                ...
                <div className="p-8 bg-gray-50 grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div className="mt-6">
                            ...
                            <button onClick={() => handleReview()} className="mt-2 py-2 px-4 border border-gray-300 rounded-lg text-sm">
                                Write a review
                            </button>
                        ...
                        {reviews && reviews.length > 0 ? (
                            reviews.map((review, index) => (
                                <div key={index} className="mb-8">
                                    <div className="flex items-center mb-2">
                                        <img
                                            src={review.user.profiles || 'https://images.unsplash.com/photo-1463453091185-61582044d556?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHVzZXIlMjBwcm9maWxlfGVufDB8fDB8fHww'}  // Fallback image if no profile image
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center">
                                                {Array.from({ length: 5 }, (_, i) => (
                                                    <FaStar
                                                        key={i}
                                                        className={`text-yellow-400 ${i < review.rating ? '' : 'opacity-50'}`} // Highlight filled stars
                                                    />
                                                ))}
                                            </div>
                                        </div>
                    ...
                    {loading ? (
                        ...
                        <div className="flex justify-start items-center">
                            {similarProducts.map((product) => (
                                <div key={product._id} className="p-4 cursor-pointer" onClick={() => handleViewProductClick(product._id)}>
